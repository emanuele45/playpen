...
function template_main()
{
	...
	echo '
			<div class="pagesection">
				...
				<div class="pagelinks floatleft">', $txt['pages'], ': ', template_page_index('page_index'), !empty($modSettings['topbottomEnable']) ? $context['menu_separator'] . ' &nbsp;&nbsp;<a href="#lastPost"><strong>' . $txt['go_down'] . '</strong></a>' : '', '</div>
			</div>';
	...
	echo '
			<div class="pagesection">
				...
				<div class="pagelinks floatleft">', $txt['pages'], ': ', template_page_index('page_index'), !empty($modSettings['topbottomEnable']) ? $context['menu_separator'] . ' &nbsp;&nbsp;<a href="#top"><strong>' . $txt['go_up'] . '</strong></a>' : '', '</div>
