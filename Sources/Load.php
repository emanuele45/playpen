...
function smf_put_memcached($key, $value, $ttl)
{
...
function smf_put_eaccelerator($key, $value, $ttl)
{
	// eAccelerator...
...
function smf_put_mmcache($key, $value, $ttl)
{
	// Turck MMCache?
...
function smf_put_apc($key, $value, $ttl)
{
...
function smf_put_zend($key, $value, $ttl)
{
...
function smf_put_xcache($key, $value, $ttl)
{
...
function smf_put_filecache($key, $value, $ttl)
{
...
function smf_get_mmcache($key, $ttl)
{
...
function smf_get_zend($key, $ttl)
{
	// Zend's pricey stuff.
	if (function_exists('zend_shm_cache_fetch'))
		return zend_shm_cache_fetch('SMF::' . $key, $ttl);
...
function smf_get_xcache($key, $ttl)
{
...
function smf_get_filecache($key, $ttl)
{
