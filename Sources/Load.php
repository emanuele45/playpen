...
function loadMemberContext($user, $display_custom_fields = false)
{
	...
	if ($context['loadMemberContext_set'] != 'minimal')
		$memberContext[$user] += array(
			...
			'group_icons' => str_repeat('<img src="' . str_replace('$language', $context['user']['language'], isset($profile['icons'][1]) ? $settings['images_url'] . '/membergroup_icons/' . $profile['icons'][1] : '') . '" alt="*" />', empty($profile['icons'][0]) || empty($profile['icons'][1]) ? 0 : $profile['icons'][0]),
