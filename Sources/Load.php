	...
	if ($context['loadMemberContext_set'] != 'minimal')
		$memberContext[$user] += array(
			...
			'karma' => array(
				...
				'allow' => !$user_info['is_guest'] && !empty($modSettings['karmaMode']) && $user_info['id'] != $user && allowedTo('karma_edit') && ($user_info['posts'] >= $modSettings['karmaMinPosts'] || $user_info['is_admin']),
			),
