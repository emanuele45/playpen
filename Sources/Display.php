...
function Display()
{
	...
	$context['page_index'] = prepareContextPageIndex($scripturl . '?topic=' . $topic . '.%1$d', $_REQUEST['start'], $context['total_visible_posts'], $context['messages_per_page'], true);
	$context['page_index']['can_show_all'] = $can_show_all;
